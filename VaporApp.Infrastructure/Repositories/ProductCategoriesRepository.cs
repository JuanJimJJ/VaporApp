...
namespace VaporApp.Infrastructure.Repositories
{
    public class ProductCategoriesRepository : IProductCategoriesRepository
    {
        ...
        public void UpdateProductCategories(ProductCategories products)
        {
            var productCategoryExisting = _context.ProductCategories.FirstOrDefault(x => x.IdProductCategory == products.IdProduct);
